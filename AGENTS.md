...
0. **mythos-singleshot-thinking-intelligence** — wird 3× parallel gefeuert. Jede Instanz führt einen eigenständigen Mythos Single-Forward-Pass durch und liefert einen Thinking-Pass-Output (Optionen, Bewertungen, Empfehlung, Konfidenz). Produziert **kein** Artefakt, **keine** Lösung — nur das Thinking. Wird vom Executor ausgewählt/kombiniert.
